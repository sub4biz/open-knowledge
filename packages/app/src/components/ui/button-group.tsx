...
function ButtonGroup({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: a button group is a generic toolbar-style cluster of buttons, not a form control set; <fieldset> would impose form-field semantics + default chrome. role="group" on a div is the shadcn-canonical shape.
    <div
      role="group"
