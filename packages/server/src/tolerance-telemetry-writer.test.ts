...
describe('initToleranceTelemetryWriter', () => {
  ...
  test('writes JSONL when flag is ON', () => {
  ...
  test('appends multiple fires to same file', () => {
    process.env.OK_BRIDGE_TOLERANCE_TELEMETRY = '1';
    initToleranceTelemetryWriter(tmpProjectDir);
  ...
  test('multi-class fire produces one line per class', () => {
    process.env.OK_BRIDGE_TOLERANCE_TELEMETRY = '1';
    initToleranceTelemetryWriter(tmpProjectDir);
  ...
  test('null document name serializes as null', () => {
    process.env.OK_BRIDGE_TOLERANCE_TELEMETRY = '1';
    initToleranceTelemetryWriter(tmpProjectDir);
  ...
  test('teardown stops further writes', () => {
    process.env.OK_BRIDGE_TOLERANCE_TELEMETRY = '1';
    initToleranceTelemetryWriter(tmpProjectDir);
